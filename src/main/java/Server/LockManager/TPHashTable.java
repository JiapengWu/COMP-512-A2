...
public class TPHashTable
{
	...
	private int m_tableSize; // size of the hash table, number of lists
	...
	TPHashTable(int p_tableSize)
	{
		...
		// list of list of transactions objects, each representing a transaction lock
	...
	// return all transaction objects whose xid == xobj.xid
